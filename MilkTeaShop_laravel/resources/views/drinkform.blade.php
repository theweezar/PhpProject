...
<form id="drink_form" enctype="multipart/form-data" class="w-75" action="{{url('/drink/insert')}}" method="POST">
  ...
  <div class="form-group row">
    <label for="drink_type" class="col-sm-3 col-form-label">Drink type</label>
    <div class="col-sm-9">
      <select id="drink_type" name="drink_type" class="custom-select">
...
<script>
  document.getElementById("submit-btn").addEventListener("click", function(event){
    ...
    // const drink_type = document.getElementById('drink_type')
